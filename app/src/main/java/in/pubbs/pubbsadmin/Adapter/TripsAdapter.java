...
public class TripsAdapter extends RecyclerView.Adapter<TripsAdapter.HolderClass> {
    ArrayList list;
    public TripsAdapter() {
    }

    public TripsAdapter(ArrayList list) {
        this.list = list;
    }
    ...
    public class HolderClass extends RecyclerView.ViewHolder {
        ...
        public HolderClass(@NonNull View itemView) {
            ...
            icon.setImageResource(R.drawable.ic_cycle_rider);
        }
    }
}
