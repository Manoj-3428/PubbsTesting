...
public class BottomSheetRateChartFragment extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        descriptionHeader.setText(R.string.area_rate_chart_header);
        description_ = view.findViewById(R.id.description_);
        description_.setText(R.string.area_rate_chart_header_subtitle);
        description = view.findViewById(R.id.description);
        description.setText(R.string.description_add_rate);
        areaNow = view.findViewById(R.id.area_now);
        areaNow.setText(R.string.rate_now);
