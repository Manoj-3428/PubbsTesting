...
public class BottomSheetAreaLegalFragment extends BottomSheetDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        descriptionHeader.setText(R.string.select_area_legal);
        description_ = view.findViewById(R.id.description_);
        description_.setText(R.string.select_area_legal_subtitle);
        description = view.findViewById(R.id.description);
        description.setText(R.string.select_area_legal_desc);
        areaNow = view.findViewById(R.id.area_now);
        areaNow.setText(R.string.area_legal_bottomLine);
